        ...
        <div className="center-container">
            <div className="left-container">
                <div className="left-block">
                    ...
                    <div className="left-img">
                        <img src="https://i0.wp.com/en.split-techcity.com/wp-content/uploads/sites/2/2021/07/1-scaled.jpg?resize=400%2C230&ssl=1" alt="" />
                    </div>
                    <div>
                    ...
                    <div className='left-title'>
                        Split Founders: Ante Dagelić
                    </div>
                    <div className='left-desc'>
                        Lorem Ipsum  Nullam porta vitae turpis non scelerisque. Aenean egestas
                    </div>
                    <div className='left-span-below'> 
                        
                        <div>
                            <img  src="https://en.split-techcity.com/wp-content/uploads/sites/2/2021/05/stc-logo-circle.svg" alt="" /> 
                        </div>
                        <div>
                            <span>Split Tech City </span>
                        </div>
                    </div> 
                 </div>
            ...
            <div className="right-container">
                ...
                <div className="right-block">
                    ...
                    <button type='button'> Explore community </button>
                ...
                <div className="right-block">
                    ...
                    <div className="right-desc">
                    It’s not a Hogwarts owl, but you can still feel a bit of magic once our letter arrives in your inbox! Subscribe to Split Tech City newsletter!
                    </div>
